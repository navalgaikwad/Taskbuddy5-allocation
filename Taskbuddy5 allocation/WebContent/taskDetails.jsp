...
<header>
	...
	<h1>Detailed description of your Task</h1>
<br/>
<br/>
	<table>
        <thead>
        ...
        <tr>
     	...
     	<tbody>
        	    ...
        	    <tr>
        	<td> appointer's name </td><td> ${appointer.userfirstname} </td>
        		</tr>
        		<tr>
        	<td> appointer's address details </td><td> ${operation.addressdetails} </td>
        		</tr>
        		<tr>
        	<td> appointment date </td><td> ${operation.date} </td>
        		</tr>
        		<tr>
        	<td> appointer's contact number </td><td> ${appointer.contactno} </td>
        		</tr>
         
         </tbody>
         
         </table> 
	<button class="button" onclick="window.location.href='accomplishment?opid=${operation.opid}'">Task Accomplished!</button>
<br><br><br>
