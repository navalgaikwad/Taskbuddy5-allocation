...
<body>
 <header>
    ...
    <br>
    <br>
        <h3>taskers yet to visit</h3>
     <table>
        <thead>
        <tr>
        	<td> <b>category</b> </td>
        	<td> <b>visiting charge</b> </td>
        	<td> <b>at address</b> </td>
        	<td> <b>date</b> </td>
        	<td> <b>action</b> </td>
        <tr>
        </thead>
         ...
         <c:forEach var="item" items="${requestScope.yetToVisit}">
        	    <tr>
        	<td> ${item.taskerinfo.category} </td><td> ${item.taskerinfo.charge} </td><td> ${item.addressdetails} </td><td> ${item.date} </td><td> <button class="button" onclick="window.location.href='writeReview?opid=${item.opid}'">Cancel</button> </td>
        		</tr>
         </c:forEach>
         </tbody>
      </table>
         ...
         <h3>taskers have reported the task to be complete. please confirm and rate the tasker</h3>
         <table>
        <thead>
        <tr>
        	<td> <b>category</b> </td>
        ...
        <tr>
         ...
         <c:forEach var="item" items="${yetToRate}">
        	    <tr>
        	<td> ${item.taskerinfo.category} </td><td> ${item.taskerinfo.charge} </td><td> ${item.addressdetails} </td><td> ${item.date} </td><td> <button class="button" onclick="window.location.href='writeReview?opid=${item.opid}'">Rate</button> </td>
        		</tr>
         </c:forEach>
         </tbody>
