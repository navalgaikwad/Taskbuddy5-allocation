...
<form action="afterReview" method="post">

	<input type="hidden" value="${op.opid}" name="opid" >
   	<input type="hidden" value="${op.logininfo.loginid}" name="logininfo.loginid" >
	<input type="hidden" value="${op.taskerinfo.taskerid}" name="taskerinfo.taskerid">
	<input type="hidden" value="${op.addressdetails}" name="addressdetails">
<table>
<thead>
<tr>
	<td>form field</td>
...
<tbody>
	...
	<tr><td>Tasker's name</td><td><input type="text" value="${op.taskerinfo.logininfo.username}" disabled="disabled"></td></tr>
	
	<tr><td>Date</td><td><input type="text" name="date" value="${op.date}"></td></tr>
	
	<tr><td>Write review</td><td><textarea name="reveiw" ></textarea></td></tr> 
	 
	<tr><td>Rate Tasker</td><td> <select name="rating" >
