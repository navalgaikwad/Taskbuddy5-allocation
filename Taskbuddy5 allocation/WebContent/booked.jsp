...
href="menu1?type=${item}" name="${item}">${item}<br/></a>
         ...
         <h1>Tasker is booked!</h1>
         <strong>the specified tasker is booked for your location!</strong>
         <p>please stay present at your location on the specified date. thank you for choosing <strong>TASKBUDDY</strong></p>
