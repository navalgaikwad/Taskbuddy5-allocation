...
<%-- <sf:form action="task"> --%>
	...
	<input type="hidden" value="${sessionScope.user.loginid}" name="logininfo.loginid" >
	<input type="hidden" value="${op.taskerinfo.taskerid}" name="taskerinfo.taskerid">
    <input type="hidden" value="incomplete" name="reveiw">
<table>
<thead>
<tr>
	<td>form field</td>
...
<tbody>
	...
	<tr><td>location</td><td><input type="text" value=" ${sessionScope.location}" disabled="disabled"><br><br>
	
	 
	 
	 <tr><td>Address details</td><td><textarea name="addressdetails" ></textarea></td></tr>
