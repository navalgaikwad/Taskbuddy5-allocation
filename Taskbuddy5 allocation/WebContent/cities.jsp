...
<a style="color:white; font-weight:bolder; " href="menu2?type=${param.type}&category=${catlist}" name="${cat}">${catlist}<br/></a>
        ...
        <div class="col-lg-4">
         ...
         <%if((username!=null)){ %>
        <div class="row">
        	<h2><a href="quickBook">QUICK BOOKING>>>>>></a></h2>
        	<p>Book a tasker for your registered address quickly</p>
        	<br/><br/><br/><br/>
        	<h2>select the city you wish to book a tasker in</h2>
        ...
        <div class="col-lg-4">
          <img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140">
          <h2><a href="locationSelection?city=${item}">${item}<br/> </a></h2>
          <p>Experienced Tasker and professional Skill services</p>
          </div>
